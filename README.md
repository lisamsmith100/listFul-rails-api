# listFul
  ...
  [listFul](https://lisamsmith100.github.io/listFul/) lets users generate a list with items and generate templates with items. A list or template can be created, edited, or deleted from the browser.

  listFul is built using a front-end framework, Ember (also Javascript, CSS, and Handlebars) and relies on a Rails API/Postgres to persist data. Code for that API can be found at lisamsmith100/listFul-rails-api](<https://github.com/lisamsmith100/listFul-rails-api>).
...
- Template Items
  ...
  The project culminated from experience and desire to have an app with this functionality. The wireframes looks like this: [here](http://imgur.com/BiEzJn2).
