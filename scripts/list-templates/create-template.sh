#!/bin/bash
#TOKEN=BAhJIiU0OWQzOWY1ZGI5MTg4ZjU4ZTQxZWRjYjc1MTBkNWYyYQY6BkVG--2c391ac2b43dcb03690bd9507030854a25f82858 TEMPLATE_NAME="third list template for user lms" TEMPLATE_CATEGORY="WDI" TEMPLATE_STATUS=false TEMPLATE_REMINDER=true TEMPLATE_REMINDER_DATE="2017-06-09" sh scripts/list-templates/create-template.sh
