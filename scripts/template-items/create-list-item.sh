#!/bin/bash
#LIST_ID=10 TOKEN=BAhJIiUyOGJmYTgwZmJkN2NiYWY2Zjg1NGM0MjIxMzQxODZjOQY6BkVG--72ae784ca37ab4f39ce73570307545b4b40dc2a4 LIST_ITEM_NAME="durian" LIST_ITEM_STATUS=false LIST_ITEM_REMINDER=true LIST_ITEM_REMINDER_DATE="2017-06-09" sh scripts/list-items/create-list-item.sh
